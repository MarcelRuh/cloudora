...
- Product name is **Cloudora** everywhere (UI, cookies, Docker, docs).
...
- Stack: Next.js 16, Prisma 6, PostgreSQL 16, Tailwind 4. Native systemd by default; Docker optional.
